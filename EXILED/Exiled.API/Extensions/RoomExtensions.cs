// -----------------------------------------------------------------------
// <copyright file="RoomExtensions.cs" company="ExMod Team">
...
namespace Exiled.API.Extensions
{
    ...
    public static class RoomExtensions
    {
        ...
        /// <returns>Returns whether the <see cref="RoomType"/> is a gate.</returns>
        ...
        /// </summary>
        /// <param name="room">The room to be checked.</param>
        /// <returns>Returns whether the <see cref="RoomType"/> is a checkpoint.</returns>
        ...
        /// </summary>
        /// <param name="room">The room to be checked.</param>
        /// <returns>Returns whether the <see cref="RoomType"/> is a Lcz checkpoint.</returns>
        ...
        /// </summary>
        /// <param name="room">The room to be checked.</param>
        /// <returns>Returns whether the <see cref="RoomType"/> is a Hcz checkpoint.</returns>
