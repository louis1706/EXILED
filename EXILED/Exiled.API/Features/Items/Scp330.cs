...
namespace Exiled.API.Features.Items
{
    ...
    public class Scp330 : Usable, IWrapper<Scp330Bag>
    {
        ...
        /// <param name="dropAll">Whether to drop all candies matching the given type, or just one.</param>
        /// <param name="dropIndividual">Whether to drop all candies individually, or as a bag, when dropping more than one candy.</param>
