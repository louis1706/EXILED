// -----------------------------------------------------------------------
// <copyright file="ChangingCameraEventArgs.cs" company="ExMod Team">
...
namespace Exiled.Events.EventArgs.Scp079
{
    ...
    public class ChangingCameraEventArgs : IScp079Event, ICameraEvent, IDeniableEvent
    {
        ...
        /// <para>Defaults to a value describing whether SCP-079 has enough auxiliary power to switch.</para>
